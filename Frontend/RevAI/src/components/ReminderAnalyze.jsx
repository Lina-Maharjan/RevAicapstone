...
export default function ReminderAnalyze() {
  ...
  const handleClick = () => {
    navigate("/Analyzer"); // this matches the route in main.jsx
  };
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-[#111827] px-4 text-center bg-gradient-to-b from-[#E6FFFA] via-[#E5FDF8] to-white bg-[length:100%_400px] bg-no-repeat">
      ...
      <button onClick={handleClick}  className="bg-gradient-to-r from-[#14B8A6] to-[#0D9488] text-white font-semibold py-3 px-6 rounded-xl shadow-md hover:brightness-110 transition duration-300">
        Start Analyzing
      </button>
    </div>
  );
